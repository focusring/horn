...
features:
  ...
  - icon: "\uD83D\uDD0D"
    ...
    details: All 136 failure conditions of the Matterhorn Protocol 1.1 for PDF/UA-1 (ISO 14289-1) — 87 machine-checkable conditions automated, 48 human-judgment conditions surfaced for manual review. 100% on the veraPDF PDF/UA-1 corpus.
  - icon: "\uD83D\uDE80"
    title: CI/CD Native
